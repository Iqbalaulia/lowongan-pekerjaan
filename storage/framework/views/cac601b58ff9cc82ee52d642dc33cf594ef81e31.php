                ...
                <div class="action">
                   <div class="row">
                    <ul>
                        ...
                        <li>
                            <a style="width:100%" href="<?php echo e(route('email-berkas-diterima.show',$lamaran->id)); ?>" class="btn btn-success">Diterima</a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('email-berkas-ditolak.show',$lamaran->id)); ?>" class="btn btn-danger">Ditolak</a>

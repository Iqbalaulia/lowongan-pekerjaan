                ...
                <div class="action">
                   <div class="row">
                    <ul>
                        ...
                        <li>
                            <a style="width:100%" href="<?php echo e(url('email-berkas-diterima')); ?>" class="btn btn-success">Diterima</a>
                        </li>
                        <li>
                            <a href="<?php echo e(url('email-berkas-ditolak')); ?>" class="btn btn-danger">Ditolak</a>

<aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
          <div class="main-navbar">
            <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
              ...
              <!-- before -->
                ...
                <img id="main-logo" class="d-inline-block align-top mr-1" style="max-width: 25px;" src="{{URL::asset('/images/shards-dashboards-logo.svg')}}" alt="Shards Dashboard">
          ...
          <div class="nav-wrapper">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link " href="{{route('accpengajuan.index')}}">
                <!-- before -->
              ...
              <li class="nav-item">
                <a class="nav-link " href="{{route('hasiltest.index')}}">
                <!-- before -->

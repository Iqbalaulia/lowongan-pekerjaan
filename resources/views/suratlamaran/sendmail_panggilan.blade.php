...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header bg-primary text-white">Panggilan Interview</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('send/email-berkas-diterima') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control" name="message" id="" cols="30" rows="5">Selamat Anda mendapat undangan untuk melakukan interview sesuai divisi yang pernah anda lamar,segera datang untuk melanjutkan test selanjutnya pada :
Tanggal :
Pukul   :
Tempat  :
